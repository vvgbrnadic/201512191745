...
public class izborIznosaDat implements java.io.Serializable
{
   ...
   @org.kie.api.definition.type.Label(value = "Tristo")
   private java.lang.Boolean tristo;
   @org.kie.api.definition.type.Label(value = "Petsto")
   private java.lang.Boolean petsto;
   @org.kie.api.definition.type.Label(value = "Tisucu")
   private java.lang.Boolean tisucu;
   @org.kie.api.definition.type.Label(value = "PetTisuca")
